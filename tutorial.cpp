...
void CTutorial::Draw()
{
	...
	for (int i = 0; i < m_text.size(); i++)
	{
		...
		wsprintf(str, _T(m_text[i].c_str()));

		m_font->DrawText(NULL, str, -1, &rect, DT_CENTER, m_isSuccess[i] ? CApplication::GetInstance()->GetColor(3) :CApplication::GetInstance()->GetColor(0));
	}
}
...
void CTutorial::ResetText()
{
	...
	if (m_controllerIndex == -1)
	{
		...
		case CTutorial::MOVE:
		{
			...
			m_isSuccess[2] = false;
			m_isSuccess[3] = false;
			m_text[0] = "・Ｗキーを押して上に移動\n";
			m_text[1] = "・Ａキーを押して左に移動\n";
			m_text[2] = "・Ｓキーを押して下に移動\n";
			m_text[3] = "・Ｄキーを押して右に移動\n";
		}
		break;
		case CTutorial::SHOT:
		{
		...
		case CTutorial::CHARGE:
		{
			...
			m_isSuccess[2] = false;
			m_isSuccess[3] = false;
			m_text[0] = "・↑キーを長押して上に撃つ\n";
			m_text[1] = "・←キーを長押して左に撃つ\n";
			m_text[2] = "・↓キーを長押して下に撃つ\n";
			m_text[3] = "・→キーを長押して右に撃つ\n";
		}
		break;
		default:
			break;
	...
	else
	{
		...
		case CTutorial::SHOT:
		{
			...
			m_isSuccess[2] = false;
			m_isSuccess[3] = false;
			m_text[0] = "・Ｘキーを押して上に撃つ\n";
			m_text[1] = "・Ｙキーを押して左に撃つ\n";
			m_text[2] = "・Ａキーを押して下に撃つ\n";
			m_text[3] = "・Ｂキーを押して右に撃つ\n";
		}
		break;
		case CTutorial::CHARGE:
		{
			...
			m_isSuccess[2] = false;
			m_isSuccess[3] = false;
			m_text[0] = "・Ｘキーを長押して上に撃つ\n";
			m_text[1] = "・Ｙキーを長押して左に撃つ\n";
			m_text[2] = "・Ａキーを長押して下に撃つ\n";
			m_text[3] = "・Ｂキーを長押して右に撃つ\n";
		}
		break;
		default:
			break;
